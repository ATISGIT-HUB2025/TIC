...
$total_e = DB::table('cusotmers')->count();
?>
            ...
            <div class="mobile-menu">
              <nav id="dropdown">
                <ul class="mobile-menu-nav">
                  ...
                  <li>
                    <a href="/crm/customers-list"> Customers List <span class="text-danger">(<?= $total_e ?> )</span></a>
                  </li>
                  <li>
                    <a href="/crm/delivery-list"> Delivery List</a>
                  </li>
                  {{-- <li>
                    <a href="/crm/ongoing-list"> On Going List</a>
                  </li>
                  <li>
                    <a href="/crm/new-work-list"> New Work List</a>
                  </li> --}}
                  <li>
                    <a href="/crm/birthday-reminder"> Birthday-reminder</a>
                  </li>
{{--
                  <li>
                    <a
                  ...
                  <li>
                    ...
                    <ul
                      ...
                      class="collapse dropdown-header-top"
                    >
                      <li><a href="/crm/customers-list">Total Customers <span class="text-danger">(<?= $total_e ?> )</span></a></li>
                      <li><a href="/crm/delivery-list">Todays Delivery</a></li>
                      {{-- <li><a href="/crm/ongoing-list">Total Ongoing</a></li> --}}
                      {{-- <li><a href="/crm/new-work-list">New Work</a></li> --}}
                      {{-- <li><a href="/crm/new-work-list">New Work</a></li> --}}
                    </ul>
                  </li>
                </ul>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
              <li class="{{ Request::is('crm/dashboard') ? 'active' : '' }}">
                <a href="/crm/dashboard"
                  ><i class="notika-icon notika-house"></i> Home</a
                >
              </li>
              <li class="{{ Request::is('crm/add-customers') ? 'active' : '' }}">
                <a href="/crm/add-customers"
                  ><i class="notika-icon notika-support"></i>Add Customers</a
                >
              </li>
              <li class="{{ Request::is('crm/customers-list') ? 'active' : '' }}">

                <a href="/crm/customers-list"
                  ><i class="notika-icon notika-support"></i> Customers List  <span class="text-danger">(<?= $total_e ?> )</span></a>
              </li>
              <li class="{{ Request::is('crm/delivery-list') ? 'active' : '' }}">
                <a href="/crm/delivery-list"

                  ><i class="notika-icon notika-windows"></i> Todays Delivery
                  <span class="text-danger">(<?= today_delivery() ?>)</span></a
                >
              </li>
              {{-- <li class="{{ Request::is('crm/dashboard') ? 'active' : '' }}">
                <a href="/crm/ongoing-list"
                  ><i class="notika-icon notika-bar-chart"></i> Total OnGoing
                  <span class="text-danger">(20)</span></a
                >
              </li>
              <li class="{{ Request::is('crm/dashboard') ? 'active' : '' }}">
                <a href="/crm/new-work-list"
              ...
              <li class="{{ Request::is('crm/birthday-reminder') ? 'active' : '' }}">
                <a href="/crm/birthday-reminder"
                  ><i class="notika-icon notika-alarm"></i> Birthday Reminder <span class="text-danger">(<?= birthdayReminder() ?>)</span></a
                >
              </li>

              <li class="{{ Request::is('crm/birthday-reminder') ? 'active' : '' }}">
                <a href="/crm/birthday-reminder"
                  ><i class="notika-icon notika-alarm"></i>Delivery Notification</a
                >
              </li>

              <li class="{{ Request::is('crm/asignto') ? 'active' : '' }}">
                <a href="/crm/asignto"
                  ><i class="notika-icon notika-form"></i>Asign TO C/W</a
                >
              </li>
            </ul>
            <div class="tab-content custom-menu-content">
              ...
              >
                <ul class="notika-main-menu-dropdown">
                  <li><a href="/crm/customers-list">Total Customers</a></li>
                  <li><a href="/crm/delivery-list">Todays Delivery</a></li>
                  <li><a href="/crm/ongoing-list">Todays Ongoing</a></li>
                  <li><a href="/crm/new-work-list">New Work</a></li>
                </ul>
              </div>
            </div>
