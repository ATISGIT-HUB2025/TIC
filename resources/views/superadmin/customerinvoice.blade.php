...
<html class="no-js" lang="">
  ...
  <body>
    ...
    <div class="">
      <div class="normal-table-list">
        <div class="bsc-tbl-bdr">
          <div style="display: flex; justify-content: space-between">
            <div>
              <h4 class="" style="color: red; font-weight: bold">
                Tax Invoice
              </h4>
            </div>
            <div>
              <h4 class="" style="color: red; font-weight: bold">
                cell. <span>+91 9090909090</span>,<span>+91 9090909090</span>
              </h4>
            </div>
          </div>
              ...
              <tr>
                <td colspan="4">
                  <div style="display: flex; gap: 10px">
                    <h5>Address:</h5>
                    <p>
                      Wadmukhwadi, Amba Bus Stop, Charholl Budruk, Near Uttam
                      Sweets, Alandi - Pune Road- 4110 18
                    </p>
                  </div>
                </td>
                <td>
                  <div style="display: flex; gap: 10px">
                    <h5>Bill No:</h5>
                    <p style="font-weight: bold">{{ $row->bill_number }}</p>
                  </div>
                </td>
              </tr>
              <tr>
                <td colspan="3">
                  <div style="display: flex; gap: 10px">
                    <h5 style="text-wrap: nowrap">GST Number:</h5>
                    <p><strong>{{ $row->gst }}</strong></p>
                  </div>
                </td>
                <td rowspan="2">
                  <div>
                    <div style="display: flex; gap: 10px; margin-bottom: 5px">
                      <h5 style="text-wrap: nowrap">Order Date:</h5>
                      <p><strong>{{ date("d/m/Y", strtotime($row->order_date)) }}</strong></p>
                    </div>
                  </div>
                </td>
                <td rowspan="2">
                  <div>
                    <div style="display: flex; gap: 10px; margin-bottom: 5px">
                      <h5 style="text-wrap: nowrap">Delivery Date:</h5>
                      <p><strong>{{ date("d/m/Y", strtotime($row->delivery_date)) }}</strong></p>
                    </div>
                  </div>
                </td>
              </tr>
          ...
          <table class="table table-bordered">
            <tbody>
              <!-- Data Section -->
              <tr>
                <th colspan="1">Fabrics</th>
                <td colspan="1">{{ $row->fabrics }}</td>
                <td colspan="1">-</td>
                <td colspan="1">-</td>
                <td colspan="1">-</td>
                <td colspan="1">-</td>
              ...
              <tr>
                ...
                <th colspan="1">Advance Date</th>
                <th colspan="1">Balance</th>
                <th colspan="1">Receive</th>
                <th colspan="1">Receive Date</th>
                <th colspan="1">Salesman Code</th>
              </tr>
              <tr>
                <th colspan="1">{{ $row->total_quantity }}</th>
                <td colspan="1">Rs.{{ $row->total_amount }}</td>
                <td colspan="1">{{ $row->discount }}</td>
                <td colspan="1">{{ $row->advance }}</td>
                <td colspan="1">{{ $row->advance_date }}</td>
                <td colspan="1">{{ $row->balance }}</td>
                <td colspan="1">{{ $row->receive }}</td>
                <td colspan="1">{{ $row->receive_date }}</td>
                <td colspan="1">{{ $row->salesman_code }}</td>
              </tr>
            </tbody>
          </table>
            ...
            <tbody>
              ...
              <tr style="border: none">
                <th colspan="1" style="border: none">
                  • डिलीव्हरी वेळी पावती आणणे आवश्यक आहे.
                </th>
                <th colspan="1" style="border: none">
                  • डिलीव्हरी पुर्ण पेमेंट केल्यानंतर दिली जाईल.
                </th>
              </tr>

              <tr>
                <th colspan="1" style="border: none">
                  • डिलीव्ही तारखे पासुन १५ दीवसाच्या आत आपले कपडे घेऊन जावे
                  त्या नंतर आम्ही जबाबदार नाही.
                </th>
                <th colspan="1" style="border: none">
                  • लाईट नसल्या कारणाने डिलीव्हरीसाठी उशीर होऊ शकतो.
                </th>
              </tr>
              <tr>
                <th colspan="2" style="border: none">
                  • कपडधांच्या कलर व फिटींग बद्दल काही समस्या असल्यास डिलीव्हरी
                  तारखेस पासुन १५ दीवसाच्या आत घेवुन येणे
                </th>
              </tr>
            </tbody>
          </table>
          ...
          <table class="table table-bordered" style="margin-top: 2rem">
            <tbody style="text-align: center">
              ...
              <tr style="text-align: center">
                ...
                <th colspan="1" style="text-align: center">
                  <div>
                    <h5>डिलीव्हरी वेळ : 3:30pm to 7:30 pm</h5>
                    <h5>दुकानाची वेळ : 9:30am to 8:30 pm</h5>
                  </div>
                </th>
                <th colspan="1" style="text-align: center">
                  <img src="{{ url('') }}/superadmin/img/logo/logo.png" alt="logo" style="width: 80px" />
                  Cotton Industries
                </th>
              </tr>
            </tbody>
          ...
          >
            <tbody>
              <tr>
                <th colspan="3">
                  <img
                    src="{{ url('') }}/superadmin/img/logo/logo.png"
                    alt="logo"
                    style="width: 150px"
                  />
                </th>
      ...
      <div style="text-align: end; padding: 2rem">
        <a href="index.html">
          <button type="button" class="default-btn next-step">
            <i class="fa fa-backward"></i> Back
          </button>
        </a>
        <button type="button" onclick="window.print()" class="default-btn next-step">
