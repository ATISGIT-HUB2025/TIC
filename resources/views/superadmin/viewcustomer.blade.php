        ...
        <table class="table table-bordered">
          <tbody>
            ...
            <tr class="bg-light">
                <td>Name</td>
                <td>Quantity</td>
                @if (Auth::user()->role == "superadmin" || Auth::user()->role_type == "admin")
                <td>Amount</td>
                @endif
            </tr>
            @php
                $roundfebrics = json_decode($row->febrics_detail);
            @endphp

            @foreach ($roundfebrics as $item)

            <tr>
                <td>
                    <?= isset($item->fabrics) ? $item->fabrics : "" ?>
                </td>
