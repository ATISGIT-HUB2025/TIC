                    ...
                    <tr>
                      ...
                      <td style="text-wrap: nowrap">
                        <span class="label label-primary opp">
                            <a onclick="return confirm('Send birthday reminder to <?= $value->name ?> ')" class="text-white" href="/crm/sendbirthday/reminder/{{ $value->id }}" >Send Reminder</a>
                        </span>
                      </td>
                    </tr>
                    @endforeach
