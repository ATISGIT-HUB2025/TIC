                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              ...
                              <div class="append_moretops" id="append_moretops">
                                <div class="bsc-tbl-bdr">
                                    ...
                                    <table class="table table-bordered" id="tab_continue_one" style="    margin-top: 15px;">
                                      <thead>
                                        <tr>
                                          <th>Particulars</th>
                                          <th>Body Size</th>
