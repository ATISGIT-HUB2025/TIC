            ...
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Create Privacy-Policy</h4>
                    </div>
                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                <label for="l_desc" class="form-label">Privacy Policy</label>
                                                <textarea name="privacy_policy" id="summernote" class="form-control" cols="30" rows="3"><?=$data->info_one ?></textarea>
                                            </div>
                                        </div>
