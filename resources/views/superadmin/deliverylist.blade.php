                ...
                <tbody>
                 ...
                 @foreach ($cot as $key =>$val)
                  ...
                  <tr>
                    ...
                    <td style="text-wrap: nowrap"><?=$val->id?></td>
                    <td style="text-wrap: nowrap"><?=$val->name ?></td>
                    <td style="text-wrap: nowrap">Jamdade</td>
                    <td style="text-wrap: nowrap"><?=$val->mobile ?></td>
                    <td style="text-wrap: nowrap"><?= date('Y-m-d'); ?></td>
                    <td style="text-wrap: nowrap">
                      <span class="label label-success">Today Delivery </span>
                    </td>
                    <td>
                      ...
                      <a href="/crm/customer/invoice/{{ $val->id }}">
                        <button
