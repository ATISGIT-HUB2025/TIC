                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/add-project" role="button">Add</a>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($Project as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{ substr($item->loction, 0, 20) }}</td>
                                            <td>{{ substr($item->client, 0, 20) }}</td>
                                            <td>{{ substr($item->duration, 0, 20) }}</td>
                                            <td>
                                                <img src="/Project-image/{{ $item->image }}"
                                                    class="dyanamic_image" loading="lazy" alt="">
                                            </td>
                                            <td>
                                                <img src="/Project-Challenges-image/{{ $item->image1 }}"
                                                    class="dyanamic_image" loading="lazy" alt="">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are you sure !')"
                                                    href="{{ route('projects-delete', ['table' => 'banners', 'id' => $item->id, 'image' => $image]) }}"
                                                    class="text-danger">
                                                ...
                                                <a href="/admin/projects-update/{{ $item->id }}" class="text-primary">
                                                    <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 24 24" fill="currentColor">
                                                        <path
