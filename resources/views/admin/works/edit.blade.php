            ...
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">edit Works</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">Works Details</h5>
                            </div><!-- end card header -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="simpleinput" name="title"
                                                    value="{{$work->title}}" class="form-control">
                                                @error('title')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                @if($work->image)
                                                    <div class="mt-2">
                                                        <img src="{{ asset('work-image/' . $work->image) }}" alt="Image" style="width: 100px;">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" id="" class="form-control " cols="30" rows="5">{{$work->description}}</textarea>
        ...
        <div class="d-flex">
            ...
            <div class="form-check">
                <input 
                    ...
                    name="status" 
                    id="gridRadios1" 
                    {{ old('status', $work->status) == 'Y' ? 'checked' : '' }}>
            ...
            <div class="form-check ms-3">
                <input 
                    ...
                    name="status" 
                    id="gridRadios2" 
                    {{ old('status', $work->status) == 'N' ? 'checked' : '' }}>
