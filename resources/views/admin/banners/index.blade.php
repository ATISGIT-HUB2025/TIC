        ...
        <div class="container-fluid">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Banners</h4>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/create-banner" role="button">Add</a>
                        </div>
                            ...
                            <table id="fixed-header-datatable" class="table table-striped dt-responsive nowrap table-striped w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ url('uploads') }}/{{ $item->image }}" class="dyanamic_image" loading="lazy" alt="">
                                        </td>
                                        <td>
                                            <?php if($item->status == "Y"){ ?>
                                            <span class="badge text-bg-primary"><?= $item->status == "Y" ? "Active" : "Inactive" ?></span>
                                    <?php }else{ ?>

                                            <span class="badge text-bg-danger"><?= $item->status == "Y" ? "Active" : "Inactive" ?></span>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Are you sure !')" href="{{ route('deleterownew', ['table' => 'banners', 'id' => $item->id, 'image' => $image]) }}" class="text-danger">
                                            ...
                                            <a href="/admin/banners-edit/{{ $item->id }}" class="text-primary">
