@section('title', 'Dashboard - Sp Cotton')
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Best Service</h4>
                </div>
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item active">Best Service</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/create-best-service" role="button">Add</a>
                        </div>
                        ...
                        <div class="card-body">
                            <table id="fixed-header-datatable"
                                ...
                                <tbody>
                                    @foreach ($bestservice as $key => $item)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        <td>{{$item->title}}</td>
                                        <td>{{$item->sub_title}}</td>
                                        <td>
                                            <img src="/uploads/{{ $item->icon }}"
                                                class="dyanamic_image" loading="lazy" alt="">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Are you sure !')"
                                                href="{{ route('deletebestservice', ['table' => 'best_our_service', 'id' => $item->id, 'image' => $image]) }}"
                                                class="text-danger">
                                            ...
                                            <a href="/admin/edit-best-service/{{ $item->id }}" class="text-primary">
                                                <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24" fill="currentColor">
                                                    <path
